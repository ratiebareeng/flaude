...
class ApiConstants {
  ...
  // Error Messages
  static const String apiKeyNotSetError = 'API key not set. Please configure your API key in settings.';
  ...
  static const String rateLimitErrorMessage = 'Rate limit exceeded. Please wait and try again.';
