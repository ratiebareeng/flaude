...
class AppConstants {
  ...
  static const String appDescription = 'A lightweight Flutter app to interact with Claude via the Anthropic API.';
  ...
  static const String chatNotFoundMessage = 'Chat not found. Please start a new chat.';
  ...
  static const String chatTitleUpdatedMessage = 'Chat title updated successfully!';
  static const String projectCreatedMessage = 'Project created successfully!';
  static const String artifactAddedMessage = 'Artifact added to project knowledge';
  ...
  static const List<String> supportedDocumentFormats = ['pdf', 'txt', 'md', 'docx'];
